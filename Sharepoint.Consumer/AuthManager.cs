...
namespace Sharepoint.Consumer
{
    public class AuthManager : IDisposable
    {
        ...
        public async Task<string> EnsureAccessTokenAsync(Uri resourceUri, string userPrincipalName, string userPassword)
        {
            ...
            if (accessTokenFromCache == null)
            {
                ...
                try
                {
                    ...
                    string accessToken = await AcquireToken(resourceUri, userPrincipalName, userPassword);
        ...
        public async Task<string> AcquireToken(Uri resourceUri, string username, string password)
        {
            string formDigest = null;
            Uri resourceUrl = resourceUri;
            ...
            try
            {
                ...
                var obj = JsonConvert.DeserializeObject<Metadata>(result);
                formDigest = obj.FormDigestValue;
            }
            catch (Exception ex)
            {
                throw ex;
